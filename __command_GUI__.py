...
def wrong_attemp_warning(window, warning_line, wrong_attempts):
...
def print_menu(window, selected_row, relevant_packages, selected_status):
    ...
    # Sort the relevant_packages list by length
    #relevant_packages = sorted(relevant_packages, key=len)
...
def get_hide_output_choice(window):
    ...
    while True:
        ...
        if confirmation_key in [89, 121, 10, 13]:  # 'Y', 'y', Enter, Carriage Return
            ...
            wrong_attempts = wrong_attemp_warning(window, warning_line, wrong_attempts)
        ...
        while True:
            ...
            if confirmation_key in [
                ...
                while True:
                    ...
                    wrong_attempts = wrong_attemp_warning(
                        window, warning_line, wrong_attempts
                    )
